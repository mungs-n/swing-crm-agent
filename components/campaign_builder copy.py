...
PERSONAS = {
    "신규 탐색자": {"count": 150, "desc": "가입 14일 이내, 첫 구매 유도 필요"},
    "충동 구매자": {"count": 200, "desc": "고빈도 중액, 신상품·기획전 반응 높음"},
    "할인 구매자": {"count": 200, "desc": "세일 시즌에만 반응, 할인 쿠폰이나 적립금 효과적"},
    "브랜드 충성 고객": {"count": 150, "desc": "중빈도 재구매, VIP 혜택 선호"},
    "이탈 위험 고객": {"count": 150, "desc": "45일 이상 미구매, 재활성화 필요"},
    "휴면 고객": {"count": 150, "desc": "90일 이상 미방문, 윈백 캠페인 대상"},
}
